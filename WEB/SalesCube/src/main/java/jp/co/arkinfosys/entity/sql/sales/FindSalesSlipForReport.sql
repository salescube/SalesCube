SELECT
	...
	,S.RECEPT_NO
	,S.CUSTOMER_SLIP_NO
	,S.SALES_CM_CATEGORY AS CM_CATEGORY_CODE
	,S.SALES_CUTOFF_DATE
	...
	,S.PO_PRINT_COUNT
	,S.ART_ID
	,CAT.CATEGORY_CODE_NAME AS SALES_CM_CATEGORY
    FROM
        SALES_SLIP_TRN_/*$domainId*/ S
        	LEFT OUTER JOIN CATEGORY_TRN_/*$domainId*/ CAT ON (S.SALES_CM_CATEGORY = CAT.CATEGORY_CODE AND CAT.CATEGORY_ID = /*salesCmCategory*/32 )
    /*BEGIN*/
	WHERE
