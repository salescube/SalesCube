<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<meta name="author" content="アーク情報システム">
	<meta name="copyright" content="アーク情報システム">
	<meta name="keywords" content="販売管理システム">
	<meta name="description" content="販売管理システム">

	<link rel="shortcut icon" href="${f:url('/images/favicon.ico')}">
	<link rel="stylesheet" href="${f:url('/css/default.css')}" type="text/css">
	...
	<!--
		...
		var domainId = "${domainDto.domainId}";
	-->
	</script>
