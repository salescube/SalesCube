...
<% response.setHeader("Content-Disposition", "attachment; filename=\"PURCHASE_SLIP.xls\"" );%>
...
<body>
	<span id="searchResultList">
		<%@ include file="/WEB-INF/view/purchase/searchPurchaseResultOutput/resultList.jsp" %>
	</span>
</body>
</html>