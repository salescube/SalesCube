...
<body onhelp="return false;">
	...
	<div id="main_function">
		...
		<div class="function_buttons">
	        <button id="btnF1"  onclick="onF1();" tabindex="2000">F1<br>初期化</button><button
	        	disabled="disabled">F2<br>&nbsp;</button><button
	        	id="btnF3" onclick="onF3();" tabindex="2001">F3<br>一括更新</button><button
		...
		<div class="function_forms">
			<s:form onsubmit="return false;" styleId="entryZipCodeForm" action="upload" enctype="multipart/form-data" method="POST">
				<div id="main_function">
					...
					<button id="importBtn" onclick="submitForm()" tabindex="150">一括更新</button>
				</div>
			</s:form>
		</div>
	</div>
