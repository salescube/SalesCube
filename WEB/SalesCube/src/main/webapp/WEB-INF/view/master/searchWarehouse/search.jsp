...
<c:if test="${isUpdate}">
    ...
    <div class="function_forms">
        ...
        <div style="text-align: right; width: 910px">
			<button type="button" tabindex="150" style="width: 80px;"  onclick="initForm();">初期化</button>
			<button type="button" tabindex="151" style="width: 80px;" onclick="searchWarehouse();">検索</button>
        </div>
		...
		<div id="ListContainer">
            ...
            <table id="search_result" summary="検索結果" class="forms" style="width: 910px">
                ...
                <tr>
					<th style="cursor: pointer">倉庫コード</th>
					<th style="cursor: pointer">倉庫名</th>
					<th>倉庫状況</th>
			        <th>&nbsp;</th>
			     </tr>
            </table>
