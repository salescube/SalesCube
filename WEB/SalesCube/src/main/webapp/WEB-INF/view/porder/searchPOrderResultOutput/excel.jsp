...
<% response.setHeader("Content-Disposition", "attachment; filename=\"PORDER_SEARCH_RESULT.xls\"" );%>
...
<body>
	<span id="searchResultList">
		<%@ include file="/WEB-INF/view/porder/searchPOrderResultOutput/resultList.jsp" %>
	</span>
</body>
</html>