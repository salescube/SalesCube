	...
	<html:messages id="msg" message="true">
		...
		<div class="function_forms">
			<table id="search_info1" class="forms" style="width: 600px" summary="取込ファイル">
				...
				<tr>
					<th><bean:message key='labels.bank.deposit.csv'/></th> <!-- 入金CSVファイル-->
			...
			<div style="width: 600px; text-align :right;">
				<button type="button" id="initBtn" onclick="onF1();" tabindex="150"><bean:message key='words.action.initialize'/></button> <!-- 初期化 -->
				<button type="button" id="importBtn" onclick="onF2();" tabindex="151"><bean:message key='words.action.uptake'/></button> <!-- 取込 -->
