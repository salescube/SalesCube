...
<body>
	...
	<div id="main_function">
		...
		<div class="function_buttons">
			...
			</button><button type="button" id="btnF3" tabindex="2002" onclick="onF3();">F3<br><bean:message key='words.name.excel'/><%// EXCEL %>
		...
		<s:form onsubmit="return false;">
			...
			<div class="function_forms">
				...
				<table id="search_info1" class="forms" summary="出力条件">
					...
					<tr>
						<th rowspan="2"><bean:message key='labels.includeProductsSearchCondition'/></th><%// 商品の抽出条件 %>
						<td>
					...
					<tr>
						<th><bean:message key='labels.excludeProductsSearchCondition'/></th><%// 商品の除外条件 %>
						<td>
