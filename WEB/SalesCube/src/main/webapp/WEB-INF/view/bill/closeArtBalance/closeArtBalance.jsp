...
<!-- メイン機能 -->
	<div id="main_function">
		...
		<div class="function_buttons">
			...
			</button><button disabled="disabled" type="button" tabindex="2001" id="btnF2" onclick="onF2();">F2<br>&nbsp;
		...
		<div class="function_forms">
			...
			<table id="billing_close_2" summary="締処理リスト2" class="forms" style="width: 150px;">
				<colgroup>
				...
				<tr>
					...
					<c:if test="${closeArtBalanceForm.lastCutOffDate == ''}" >
						<td align="center" ><bean:message key='labels.artBalanceNoData'/></td>
					</c:if>
					<c:if test="${closeArtBalanceForm.lastCutOffDate != ''}" >
						<td align="center" ><c:out value="${f:h(lastCutOffDate)}" /></td>
					</c:if>
				</tr>
			</table>
...
<div id="do_close"
	...
	<button id="closeExecButton" tabindex="3000" onclick="dcCloseArt()">ＯＫ</button><button tabindex="3001" onclick="$('#do_close').dialog('close');">キャンセル</button>
</div>
	</s:form>
	</div>
</body>
