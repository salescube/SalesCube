...
<div id="main_function">
	...
	<!-- タイトル -->
		...
		<div class="function_buttons">
			<button id="btnF1" type="button" tabindex="2000" onclick="onF1();">F1<br><bean:message key='words.action.initialize'/></button><button
			id="btnF2" type="button" tabindex="2001" onclick="onF2();">F2<br><bean:message key='words.action.search'/></button><button
			id="btnF3" type="button" tabindex="2002" onclick="onF3();" disabled="disabled">F3<br><bean:message key='words.name.excel'/></button><button
			id="btnF4" type="button" tabindex="2003" onclick="onF4();">F4<br><bean:message key='words.action.setting'/></button><button
			type="button" tabindex="2004" disabled>F5<br>&nbsp;</button><button
			type="button" tabindex="2005" disabled>F6<br>&nbsp;</button><button
			type="button" tabindex="2006" disabled>F7<br>&nbsp;</button><button
			type="button" tabindex="2007" disabled>F8<br>&nbsp;</button><button
			type="button" tabindex="2008" disabled>F9<br>&nbsp;</button><button
			type="button" tabindex="2009" disabled>F10<br>&nbsp;</button><button
			type="button" tabindex="2010" disabled>F11<br>&nbsp;</button><button
			type="button" tabindex="2011" disabled>F12<br>&nbsp;</button>
		</div>
			...
			<div class="function_forms">
				...
				<div id="search_info">
					<table id="search_info1" class="forms" summary="検索条件1">
						...
						<tr>
							<th><bean:message key='labels.roDate'/></th> <!-- 受注日 -->
							<td>
								<html:text property="roDateFrom" styleId="roDateFrom" styleClass="date_input" style="width: 85px;ime-mode:disabled;" tabindex="103" />
								<bean:message key='labels.betweenSign'/> <!-- ～ -->
								<html:text property="roDateTo" styleId="roDateTo" styleClass="date_input" style="width: 85px;ime-mode:disabled;" tabindex="104" />
							</td>
							<th><bean:message key='labels.shipDate'/></th> <!-- 出荷日 -->
							<td>
								<html:text property="shipDateFrom" styleId="shipDateFrom" styleClass="date_input" style="width: 85px;ime-mode:disabled;" tabindex="105" />
								<bean:message key='labels.betweenSign'/> <!-- ～ -->
								<html:text property="shipDateTo" styleId="shipDateTo" styleClass="date_input" style="width: 85px;ime-mode:disabled;" tabindex="106" />
							</td>
							<th><bean:message key='labels.deliveryDate2'/></th> <!-- 納期指定日 -->
							<td>
								<html:text property="deliveryDateFrom" styleId="deliveryDateFrom" styleClass="date_input" style="width: 85px;ime-mode:disabled;" tabindex="107" />
								<bean:message key='labels.betweenSign'/> <!-- ～ -->
								<html:text property="deliveryDateTo" styleId="deliveryDateTo" styleClass="date_input" style="width: 85px;ime-mode:disabled;" tabindex="108" />
							</td>
						</tr>
						<tr>
							<th><bean:message key='labels.restOnly'/></th>
							<td><html:checkbox property="restOnly" styleId="restOnly" value="1" tabindex="109" /></td>
							<th><bean:message key='labels.razyOnly'/></th>
							<td colspan="3"><html:checkbox property="razyOnly" styleId="razyOnly" value="1" tabindex="110" /></td>
						</tr>
					</table>

					<table id="search_info2" class="forms" summary="検索条件2">
						<colgroup>
