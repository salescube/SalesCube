...
<body>
	...
	<div id="main_function">
		...
		<div class="function_buttons">
			<button tabindex="2000" onclick="onF1()">F1<br>初期化
		...
		<s:form action="update">
			...
			<div class="function_forms">
				...
				<table id="snews_info1" class="forms" style="width: 910px" summary="おしらせ編集">
					...
					<tr>
						<th>おしらせ</th>
						<td><html:textarea style="width: 800px; height: 100px;" property="description" tabindex="100" /></td>
					</tr>
				</table>
				<div style="text-align: right; width: 910px">
					<button tabindex="150" onclick="onF1()" style="width: 80px;" >初期化</button>
					<c:if test="${isUpdate == true}">
					<button tabindex="151" onclick="onF3()" style="width: 80px;" >更新</button>
					</c:if>
					<c:if test="${isUpdate == false}">
					<button tabindex="151" onclick="onF3()" style="width: 80px;"  disabled="disabled">更新</button>
					</c:if>
				</div>
			</div>
		</s:form>
