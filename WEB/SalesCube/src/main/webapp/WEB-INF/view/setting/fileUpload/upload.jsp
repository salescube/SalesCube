		...
		<s:form enctype="multipart/form-data">
			<div class="function_buttons">
				<button type="button" tabindex="2000" onclick="onF1();">F1<br>初期化</button><button
					type="button" disabled="disabled">F2<br>&nbsp;</button><button
					type="button" tabindex="2002" onclick="onF3();">F3<br>登録</button><button
			...
			<div class="function_forms">
				...
				<div style="text-align: right; width: 600px">
					<button type="button" tabindex="150" onclick="onF1();">初期化</button>
					<button type="button" tabindex="151" onclick="onF3();">登録</button>
