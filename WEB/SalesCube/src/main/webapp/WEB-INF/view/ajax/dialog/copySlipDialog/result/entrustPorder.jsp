...
<div id="${dialogId}_ENTRUST_PORDER_ListContainer">
	<div style="padding: 0px; border: none; width: 550px; height: 250px; overflow: hidden;">
		<table id="${dialogId}_ENTRUST_PORDER_List" summary="伝票検索結果" style="width: 540px;">
			<colgroup>
			...
			<tr>
				<td style="text-align: center;">
					<input type="radio" name="${dialogId}_ENTRUST_PORDER_selectedSlip" value="${bean.poSlipId}"
