...
INSERT INTO BANK_MST_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,BANK_ID,ACCOUNT_OWNER_NAME,ACCOUNT_OWNER_KANA,BANK_CODE,BANK_NAME,STORE_CODE,STORE_NAME,DWB_TYPE,ACCOUNT_NUM,REMARKS,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER,NEW.BANK_ID,NEW.ACCOUNT_OWNER_NAME,NEW.ACCOUNT_OWNER_KANA,NEW.BANK_CODE,NEW.BANK_NAME,NEW.STORE_CODE,NEW.STORE_NAME,NEW.DWB_TYPE,NEW.ACCOUNT_NUM,NEW.REMARKS,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;
...
INSERT INTO BANK_MST_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,BANK_ID,ACCOUNT_OWNER_NAME,ACCOUNT_OWNER_KANA,BANK_CODE,BANK_NAME,STORE_CODE,STORE_NAME,DWB_TYPE,ACCOUNT_NUM,REMARKS,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.BANK_ID,NEW.ACCOUNT_OWNER_NAME,NEW.ACCOUNT_OWNER_KANA,NEW.BANK_CODE,NEW.BANK_NAME,NEW.STORE_CODE,NEW.STORE_NAME,NEW.DWB_TYPE,NEW.ACCOUNT_NUM,NEW.REMARKS,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;
...
INSERT INTO BANK_MST_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,BANK_ID,ACCOUNT_OWNER_NAME,ACCOUNT_OWNER_KANA,BANK_CODE,BANK_NAME,STORE_CODE,STORE_NAME,DWB_TYPE,ACCOUNT_NUM,REMARKS,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'DELETE', OLD.DEL_FUNC, now(), OLD.DEL_USER,OLD.BANK_ID,OLD.ACCOUNT_OWNER_NAME,OLD.ACCOUNT_OWNER_KANA,OLD.BANK_CODE,OLD.BANK_NAME,OLD.STORE_CODE,OLD.STORE_NAME,OLD.DWB_TYPE,OLD.ACCOUNT_NUM,OLD.REMARKS,OLD.CRE_FUNC,OLD.CRE_DATETM,OLD.CRE_USER,OLD.UPD_FUNC,OLD.UPD_DATETM,OLD.UPD_USER,OLD.DEL_FUNC,OLD.DEL_DATETM,OLD.DEL_USER);
END IF;
...
INSERT INTO USER_MST_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,USER_ID,NAME_KNJ,NAME_KANA,DEPT_ID,EMAIL,PASSWORD,EXPIRE_DATE,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER,NEW.USER_ID,NEW.NAME_KNJ,NEW.NAME_KANA,NEW.DEPT_ID,NEW.EMAIL,NEW.PASSWORD,NEW.EXPIRE_DATE,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;
...
INSERT INTO USER_MST_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,USER_ID,NAME_KNJ,NAME_KANA,DEPT_ID,EMAIL,PASSWORD,EXPIRE_DATE,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.USER_ID,NEW.NAME_KNJ,NEW.NAME_KANA,NEW.DEPT_ID,NEW.EMAIL,NEW.PASSWORD,NEW.EXPIRE_DATE,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;
...
INSERT INTO USER_MST_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,USER_ID,NAME_KNJ,NAME_KANA,DEPT_ID,EMAIL,PASSWORD,EXPIRE_DATE,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'DELETE', OLD.DEL_FUNC, now(), OLD.DEL_USER,OLD.USER_ID,OLD.NAME_KNJ,OLD.NAME_KANA,OLD.DEPT_ID,OLD.EMAIL,OLD.PASSWORD,OLD.EXPIRE_DATE,OLD.CRE_FUNC,OLD.CRE_DATETM,OLD.CRE_USER,OLD.UPD_FUNC,OLD.UPD_DATETM,OLD.UPD_USER,OLD.DEL_FUNC,OLD.DEL_DATETM,OLD.DEL_USER);
END IF;
