...
INSERT INTO BANK_MST_HIST_XXXXX(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,BANK_ID,ACCOUNT_OWNER_NAME,ACCOUNT_OWNER_KANA,BANK_CODE,BANK_NAME,STORE_CODE,STORE_NAME,DWB_TYPE,ACCOUNT_NUM,REMARKS,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER,NEW.BANK_ID,NEW.ACCOUNT_OWNER_NAME,NEW.ACCOUNT_OWNER_KANA,NEW.BANK_CODE,NEW.BANK_NAME,NEW.STORE_CODE,NEW.STORE_NAME,NEW.DWB_TYPE,NEW.ACCOUNT_NUM,NEW.REMARKS,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;
...
INSERT INTO BANK_MST_HIST_XXXXX(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,BANK_ID,ACCOUNT_OWNER_NAME,ACCOUNT_OWNER_KANA,BANK_CODE,BANK_NAME,STORE_CODE,STORE_NAME,DWB_TYPE,ACCOUNT_NUM,REMARKS,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.BANK_ID,NEW.ACCOUNT_OWNER_NAME,NEW.ACCOUNT_OWNER_KANA,NEW.BANK_CODE,NEW.BANK_NAME,NEW.STORE_CODE,NEW.STORE_NAME,NEW.DWB_TYPE,NEW.ACCOUNT_NUM,NEW.REMARKS,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;
...
INSERT INTO BANK_MST_HIST_XXXXX(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,BANK_ID,ACCOUNT_OWNER_NAME,ACCOUNT_OWNER_KANA,BANK_CODE,BANK_NAME,STORE_CODE,STORE_NAME,DWB_TYPE,ACCOUNT_NUM,REMARKS,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'DELETE', OLD.DEL_FUNC, now(), OLD.DEL_USER,OLD.BANK_ID,OLD.ACCOUNT_OWNER_NAME,OLD.ACCOUNT_OWNER_KANA,OLD.BANK_CODE,OLD.BANK_NAME,OLD.STORE_CODE,OLD.STORE_NAME,OLD.DWB_TYPE,OLD.ACCOUNT_NUM,OLD.REMARKS,OLD.CRE_FUNC,OLD.CRE_DATETM,OLD.CRE_USER,OLD.UPD_FUNC,OLD.UPD_DATETM,OLD.UPD_USER,OLD.DEL_FUNC,OLD.DEL_DATETM,OLD.DEL_USER);
END IF;
...
INSERT INTO ESTIMATE_SHEET_TRN_HIST_XXXXX(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,ESTIMATE_SHEET_ID,ESTIMATE_ANNUAL,ESTIMATE_MONTHLY,ESTIMATE_YM,ESTIMATE_DATE,DELIVERY_INFO,VALID_DATE,USER_ID,USER_NAME,REMARKS,TITLE,ESTIMATE_CONDITION,SUBMIT_NAME,SUBMIT_PRE_CATEGORY,SUBMIT_PRE,CUSTOMER_CODE,CUSTOMER_NAME,DELIVERY_NAME,DELIVERY_OFFICE_NAME,DELIVERY_DEPT_NAME,DELIVERY_ZIP_CODE,DELIVERY_ADDRESS_1,DELIVERY_ADDRESS_2,DELIVERY_PC_NAME,DELIVERY_PC_KANA,DELIVERY_PC_PRE_CATEGORY,DELIVERY_PC_PRE,DELIVERY_TEL,DELIVERY_FAX,DELIVERY_EMAIL,DELIVERY_URL,CTAX_PRICE_TOTAL,COST_TOTAL,RETAIL_PRICE_TOTAL,ESTIMATE_TOTAL,TAX_FRACT_CATEGORY,PRICE_FRACT_CATEGORY,MEMO,CUSTOMER_REMARKS,CUSTOMER_COMMENT_DATA,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.ESTIMATE_SHEET_ID,NEW.ESTIMATE_ANNUAL,NEW.ESTIMATE_MONTHLY,NEW.ESTIMATE_YM,NEW.ESTIMATE_DATE,NEW.DELIVERY_INFO,NEW.VALID_DATE,NEW.USER_ID,NEW.USER_NAME,NEW.REMARKS,NEW.TITLE,NEW.ESTIMATE_CONDITION,NEW.SUBMIT_NAME,NEW.SUBMIT_PRE_CATEGORY,NEW.SUBMIT_PRE,NEW.CUSTOMER_CODE,NEW.CUSTOMER_NAME,NEW.DELIVERY_NAME,NEW.DELIVERY_OFFICE_NAME,NEW.DELIVERY_DEPT_NAME,NEW.DELIVERY_ZIP_CODE,NEW.DELIVERY_ADDRESS_1,NEW.DELIVERY_ADDRESS_2,NEW.DELIVERY_PC_NAME,NEW.DELIVERY_PC_KANA,NEW.DELIVERY_PC_PRE_CATEGORY,NEW.DELIVERY_PC_PRE,NEW.DELIVERY_TEL,NEW.DELIVERY_FAX,NEW.DELIVERY_EMAIL,NEW.DELIVERY_URL,NEW.CTAX_PRICE_TOTAL,NEW.COST_TOTAL,NEW.RETAIL_PRICE_TOTAL,NEW.ESTIMATE_TOTAL,NEW.TAX_FRACT_CATEGORY,NEW.PRICE_FRACT_CATEGORY,NEW.MEMO,NEW.CUSTOMER_REMARKS,NEW.CUSTOMER_COMMENT_DATA,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;
...
INSERT INTO SALES_SLIP_TRN_HIST_XXXXX(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,SALES_SLIP_ID,STATUS,SALES_ANNUAL,SALES_MONTHLY,SALES_YM,RO_SLIP_ID,BILL_ID,SALES_BILL_ID,BILL_DATE,BILL_CUTOFF_GROUP,PAYBACK_CYCLE_CATEGORY,BILL_CUTOFF_DATE,BILL_CUTOFF_PDATE,SALES_DATE,DELIVERY_DATE,RECEPT_NO,CUSTOMER_SLIP_NO,SALES_CM_CATEGORY,SALES_CUTOFF_DATE,SALES_CUTOFF_PDATE,USER_ID,USER_NAME,REMARKS,PICKING_REMARKS,DC_CATEGORY,DC_NAME,DC_TIMEZONE_CATEGORY,DC_TIMEZONE,CUSTOMER_CODE,CUSTOMER_NAME,CUSTOMER_OFFICE_NAME,CUSTOMER_OFFICE_KANA,CUSTOMER_ABBR,CUSTOMER_DEPT_NAME,CUSTOMER_ZIP_CODE,CUSTOMER_ADDRESS_1,CUSTOMER_ADDRESS_2,CUSTOMER_PC_POST,CUSTOMER_PC_NAME,CUSTOMER_PC_KANA,CUSTOMER_PC_PRE_CATEGORY,CUSTOMER_PC_PRE,CUSTOMER_TEL,CUSTOMER_FAX,CUSTOMER_EMAIL,CUSTOMER_URL,DELIVERY_CODE,DELIVERY_NAME,DELIVERY_KANA,DELIVERY_OFFICE_NAME,DELIVERY_OFFICE_KANA,DELIVERY_DEPT_NAME,DELIVERY_ZIP_CODE,DELIVERY_ADDRESS_1,DELIVERY_ADDRESS_2,DELIVERY_PC_NAME,DELIVERY_PC_KANA,DELIVERY_PC_PRE_CATEGORY,DELIVERY_PC_PRE,DELIVERY_TEL,DELIVERY_FAX,DELIVERY_EMAIL,DELIVERY_URL,BA_CODE,BA_NAME,BA_KANA,BA_OFFICE_NAME,BA_OFFICE_KANA,BA_DEPT_NAME,BA_ZIP_CODE,BA_ADDRESS_1,BA_ADDRESS_2,BA_PC_NAME,BA_PC_KANA,BA_PC_PRE_CATEGORY,BA_PC_PRE,BA_TEL,BA_FAX,BA_EMAIL,BA_URL,TAX_SHIFT_CATEGORY,TAX_FRACT_CATEGORY,PRICE_FRACT_CATEGORY,CTAX_PRICE_TOTAL,PRICE_TOTAL,GM_TOTAL,COD_SC,BILL_PRINT_COUNT,DELIVERY_PRINT_COUNT,TEMP_DELIVERY_PRINT_COUNT,SHIPPING_PRINT_COUNT,SI_PRINT_COUNT,ESTIMATE_PRINT_COUNT,DELBOR_PRINT_COUNT,PO_PRINT_COUNT,ADLABEL,DISCLAIMER,CUSTOMER_REMARKS,CUSTOMER_COMMENT_DATA,ART_ID,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.SALES_SLIP_ID,NEW.STATUS,NEW.SALES_ANNUAL,NEW.SALES_MONTHLY,NEW.SALES_YM,NEW.RO_SLIP_ID,NEW.BILL_ID,NEW.SALES_BILL_ID,NEW.BILL_DATE,NEW.BILL_CUTOFF_GROUP,NEW.PAYBACK_CYCLE_CATEGORY,NEW.BILL_CUTOFF_DATE,NEW.BILL_CUTOFF_PDATE,NEW.SALES_DATE,NEW.DELIVERY_DATE,NEW.RECEPT_NO,NEW.CUSTOMER_SLIP_NO,NEW.SALES_CM_CATEGORY,NEW.SALES_CUTOFF_DATE,NEW.SALES_CUTOFF_PDATE,NEW.USER_ID,NEW.USER_NAME,NEW.REMARKS,NEW.PICKING_REMARKS,NEW.DC_CATEGORY,NEW.DC_NAME,NEW.DC_TIMEZONE_CATEGORY,NEW.DC_TIMEZONE,NEW.CUSTOMER_CODE,NEW.CUSTOMER_NAME,NEW.CUSTOMER_OFFICE_NAME,NEW.CUSTOMER_OFFICE_KANA,NEW.CUSTOMER_ABBR,NEW.CUSTOMER_DEPT_NAME,NEW.CUSTOMER_ZIP_CODE,NEW.CUSTOMER_ADDRESS_1,NEW.CUSTOMER_ADDRESS_2,NEW.CUSTOMER_PC_POST,NEW.CUSTOMER_PC_NAME,NEW.CUSTOMER_PC_KANA,NEW.CUSTOMER_PC_PRE_CATEGORY,NEW.CUSTOMER_PC_PRE,NEW.CUSTOMER_TEL,NEW.CUSTOMER_FAX,NEW.CUSTOMER_EMAIL,NEW.CUSTOMER_URL,NEW.DELIVERY_CODE,NEW.DELIVERY_NAME,NEW.DELIVERY_KANA,NEW.DELIVERY_OFFICE_NAME,NEW.DELIVERY_OFFICE_KANA,NEW.DELIVERY_DEPT_NAME,NEW.DELIVERY_ZIP_CODE,NEW.DELIVERY_ADDRESS_1,NEW.DELIVERY_ADDRESS_2,NEW.DELIVERY_PC_NAME,NEW.DELIVERY_PC_KANA,NEW.DELIVERY_PC_PRE_CATEGORY,NEW.DELIVERY_PC_PRE,NEW.DELIVERY_TEL,NEW.DELIVERY_FAX,NEW.DELIVERY_EMAIL,NEW.DELIVERY_URL,NEW.BA_CODE,NEW.BA_NAME,NEW.BA_KANA,NEW.BA_OFFICE_NAME,NEW.BA_OFFICE_KANA,NEW.BA_DEPT_NAME,NEW.BA_ZIP_CODE,NEW.BA_ADDRESS_1,NEW.BA_ADDRESS_2,NEW.BA_PC_NAME,NEW.BA_PC_KANA,NEW.BA_PC_PRE_CATEGORY,NEW.BA_PC_PRE,NEW.BA_TEL,NEW.BA_FAX,NEW.BA_EMAIL,NEW.BA_URL,NEW.TAX_SHIFT_CATEGORY,NEW.TAX_FRACT_CATEGORY,NEW.PRICE_FRACT_CATEGORY,NEW.CTAX_PRICE_TOTAL,NEW.PRICE_TOTAL,NEW.GM_TOTAL,NEW.COD_SC,NEW.BILL_PRINT_COUNT,NEW.DELIVERY_PRINT_COUNT,NEW.TEMP_DELIVERY_PRINT_COUNT,NEW.SHIPPING_PRINT_COUNT,NEW.SI_PRINT_COUNT,NEW.ESTIMATE_PRINT_COUNT,NEW.DELBOR_PRINT_COUNT,NEW.PO_PRINT_COUNT,NEW.ADLABEL,NEW.DISCLAIMER,NEW.CUSTOMER_REMARKS,NEW.CUSTOMER_COMMENT_DATA,NEW.ART_ID,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;
...
INSERT INTO PO_SLIP_TRN_HIST_XXXXX(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,PO_SLIP_ID,STATUS,PO_DATE,PO_ANNUAL,PO_MONTHLY,PO_YM,DELIVERY_DATE,USER_ID,USER_NAME,REMARKS,SUPPLIER_CODE,SUPPLIER_NAME,SUPPLIER_KANA,SUPPLIER_ABBR,SUPPLIER_DEPT_NAME,SUPPLIER_ZIP_CODE,SUPPLIER_ADDRESS_1,SUPPLIER_ADDRESS_2,SUPPLIER_PC_NAME,SUPPLIER_PC_KANA,SUPPLIER_PC_PRE_CATEGORY,SUPPLIER_PC_PRE,SUPPLIER_PC_POST,SUPPLIER_TEL,SUPPLIER_FAX,SUPPLIER_EMAIL,SUPPLIER_URL,TRANSPORT_CATEGORY,TAX_SHIFT_CATEGORY,TAX_FRACT_CATEGORY,PRICE_FRACT_CATEGORY,RATE_ID,SUPPLIER_CM_CATEGORY,PRICE_TOTAL,CTAX_TOTAL,FE_PRICE_TOTAL,PRINT_COUNT,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER,NEW.PO_SLIP_ID,NEW.STATUS,NEW.PO_DATE,NEW.PO_ANNUAL,NEW.PO_MONTHLY,NEW.PO_YM,NEW.DELIVERY_DATE,NEW.USER_ID,NEW.USER_NAME,NEW.REMARKS,NEW.SUPPLIER_CODE,NEW.SUPPLIER_NAME,NEW.SUPPLIER_KANA,NEW.SUPPLIER_ABBR,NEW.SUPPLIER_DEPT_NAME,NEW.SUPPLIER_ZIP_CODE,NEW.SUPPLIER_ADDRESS_1,NEW.SUPPLIER_ADDRESS_2,NEW.SUPPLIER_PC_NAME,NEW.SUPPLIER_PC_KANA,NEW.SUPPLIER_PC_PRE_CATEGORY,NEW.SUPPLIER_PC_PRE,NEW.SUPPLIER_PC_POST,NEW.SUPPLIER_TEL,NEW.SUPPLIER_FAX,NEW.SUPPLIER_EMAIL,NEW.SUPPLIER_URL,NEW.TRANSPORT_CATEGORY,NEW.TAX_SHIFT_CATEGORY,NEW.TAX_FRACT_CATEGORY,NEW.PRICE_FRACT_CATEGORY,NEW.RATE_ID,NEW.SUPPLIER_CM_CATEGORY,NEW.PRICE_TOTAL,NEW.CTAX_TOTAL,NEW.FE_PRICE_TOTAL,NEW.PRINT_COUNT,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;
...
INSERT INTO USER_MST_HIST_XXXXX(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,USER_ID,NAME_KNJ,NAME_KANA,DEPT_ID,EMAIL,PASSWORD,EXPIRE_DATE,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER,NEW.USER_ID,NEW.NAME_KNJ,NEW.NAME_KANA,NEW.DEPT_ID,NEW.EMAIL,NEW.PASSWORD,NEW.EXPIRE_DATE,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;
...
INSERT INTO USER_MST_HIST_XXXXX(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,USER_ID,NAME_KNJ,NAME_KANA,DEPT_ID,EMAIL,PASSWORD,EXPIRE_DATE,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.USER_ID,NEW.NAME_KNJ,NEW.NAME_KANA,NEW.DEPT_ID,NEW.EMAIL,NEW.PASSWORD,NEW.EXPIRE_DATE,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;
...
INSERT INTO USER_MST_HIST_XXXXX(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,USER_ID,NAME_KNJ,NAME_KANA,DEPT_ID,EMAIL,PASSWORD,EXPIRE_DATE,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'DELETE', OLD.DEL_FUNC, now(), OLD.DEL_USER,OLD.USER_ID,OLD.NAME_KNJ,OLD.NAME_KANA,OLD.DEPT_ID,OLD.EMAIL,OLD.PASSWORD,OLD.EXPIRE_DATE,OLD.CRE_FUNC,OLD.CRE_DATETM,OLD.CRE_USER,OLD.UPD_FUNC,OLD.UPD_DATETM,OLD.UPD_USER,OLD.DEL_FUNC,OLD.DEL_DATETM,OLD.DEL_USER);
END IF;
